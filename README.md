...
- AI refining - if a hit is detected it hits the nearby cells, - if the remained cell space does it not enough for the lenght of the remanined ships do not hit on cell
- Re add tests
